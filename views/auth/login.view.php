...
<body class="bg-[url('../../public/assets/images/BG-login.png')] bg-cover bg-center h-screen w-screen">
  ...
  <div class="overflow-hidden h-screen flex justify-center items-center relative">  <!-- Wrapper -->
    <div class="animate-fade-slide bg-white rounded-lg shadow-lg/20 overflow-hidden px-6 pb-12 mx-5 pt-2 md:px-12 md:pb-15 md:w-lg"> <!-- Login Wrapper -->
      <form id="login-form" method="POST"> 
        <div class="flex justify-center flex-col items-center gap-3 border-b-2 border-gray-200 -mx-2 md:-mx-10 pb-2 md:flex-row"> <!-- Login Header Container -->
          ...
          <div class="select-none"> <!-- System name wrapper -->
            ...
            <span class="font-roboto text-gray-400 text-center text-sm font-regular w-5 md:w-full">Your feedback helps improve teaching quality</span>
          </div>
        </div>
        ...
        <div class="flex flex-col gap-10"> <!-- Inputs Wrapper -->
          <div class="relative ">
            ...
            <input class="bg-gray-100 w-full font-roboto py-4 pl-17 text-md shadow-md rounded-xl focus:border-purple-900 focus:outline-2 focus:outline-purple-900" type="text" name="student_id" id="inputStudentID" placeholder="Student ID Number (ex. 00-0000)" required>
          </div>
          <div class="relative">
            <span class="absolute left-5 top-4 md:left-4 md:top-3.5">
            ...
            <div class="h-full w-0.5 bg-gray-300 absolute left-14"></div>
            <div></div>
            <input class="bg-gray-100 w-full font-roboto py-4 pl-17 text-md shadow-md rounded-xl focus:border-purple-900 focus:outline-2 focus:outline-purple-900" type="password" name="password" id="inputPassword" placeholder="Password" required>
        ...
        <div class="flex justify-between mt-5">
          <div class="flex items-center gap-3">
            <input class="accent-purple-900 h-4 w-4" type="checkbox" name="remember_me" id="inputCheckbox">
            <span class="font-roboto text-gray-500">Remember me</span>
          </div>
          <div>
            <a class="font-roboto font-semibold text-purple-900 underline" href="forgot_password.view.php">Forgot Password?</a>
          </div>
        </div>

        <div class="mt-6">
          <input class="w-full bg-purple-900 text-white font-semibold text-lg py-3 rounded-xl cursor-pointer hover:opacity-75" type="submit" name="signin-btn" value="Sign In">
        </div>

        <div class="mt-5">
          <p class="text-center text-md font-light" >Don't have an account? <a class="text-purple-900 font-semibold underline" href="register.view.php">Create one for teacher evaluation.</a></p>
        </div>
      </form>
    </div>
